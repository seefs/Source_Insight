...
//ShellExecute命令目录
macro getCmdPath(0)			{	return getSavePath(0) # "\\SI\\Cmd"			}
macro getTXTPath(0)			{	return getSavePath(0) # "\\SI\\Cmd_TXT"		}
macro getNodePath(0)		{	return getSavePath(0) # "\\SI\\node"		}
...
macro getPathConfig(0)		{	return getNodePath(0) # "\\set\\Macro_Set_Base.h"				}
