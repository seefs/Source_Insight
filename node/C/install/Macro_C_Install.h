...
// 展讯 工具:
Save:node\C\install\Macro_C_Install.h \[2.1\] FontTool 字体:
Save:node\C\install\Macro_C_Install.h \[2.2\] foobar2000 修改mp3 广告图标
Save:node\C\install\Macro_C_Install.h \[2.3\] ResOver 网络参数
// mtk 工具:
Save:node\C\install\Macro_C_Install.h \[3.1\] mtk--MCTApp --不知道怎么用
Save:node\C\install\Macro_C_Install.h \[3.2\] mtk--STMTView 字符串工具:
Save:node\C\install\Macro_C_Install.h \[3.3\] mtk--TRACE:
Save:node\C\install\Macro_C_Install.h \[3.4\] mtk--下载工具:
Save:node\C\install\Macro_C_Install.h \[3.5\] mtk--字体:
// 常用   工具:
Save:node\C\install\Macro_C_Install.h \[4.1\] SVN 配置:
Save:node\C\install\Macro_C_Install.h \[4.2\] BCmp 配置:
Save:node\C\install\Macro_C_Install.h \[4.3\] git:
Save:node\C\install\Macro_C_Install.h \[4.4\] vim:
Save:node\C\install\Macro_C_Install.h \[4.5\] SI:
