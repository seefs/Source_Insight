...
try:
    ...
    for row in results:
        ...
        cstr =  row[3]
        nstr =  row[4]
        searchObj = re.search(match_sch_str, cstr)
...
#        print ("w : %s" %  sublist[2])
        ...
        sql_wr = """INSERT INTO sentence_path_test_w VALUES(%s,'%s',%s,
                    ...
                    %s,%s,%s,%s,
                	%s);""";
#        print (sql_wr  % (str(sublist[0]), sublist[1], str(n3), 
#                	    str(r3),str(r4),str(r5),
#                	    sum_nval(n1, n2, n3, n4, n5), 
#                	    sum_nval(n1, n2, r3, n4, n5), 
#                	    sum_nval(n1, n2, r4, n4, n5), 
#                	    sum_nval(n1, n2, r5, n4, n5), 
#                	    sublist[2]
#                	    ));
        cursor.execute(sql_wr  % (str(sublist[0]), sublist[1], str(n3), 
                	    str(r3),str(r4),str(r5),
                	    sum_nval(n1, n2, n3, n4, n5), 
                	    sum_nval(n1, n2, r3, n4, n5), 
                	    sum_nval(n1, n2, r4, n4, n5), 
